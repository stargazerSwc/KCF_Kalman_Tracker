...
function [precision, fps] = run_tracker(video, kernel_type, feature_type, show_visualization, show_plots)
    ...
    %swc 特征尺寸限制
    features.size_lim = true; %F 1455
    features.size_lim_min = 16;
    features.size_lim_max = 32;
	...
	case 'hog',
		interp_factor = 0.01;%更新率对经过草丛的干扰有非常大的影响,越小越好
...
%         
        % 自适应cell....
%         [positions, time] = tracker_swc2(video_path, img_files, pos, target_sz, ...
%         padding, kernel, lambda, output_sigma_factor, interp_factor, ...
%         cell_size, features, show_visualization);
        % retrack
        [positions, time] = tracker_swc_retrack0505(video_path, img_files, pos, target_sz, ...
        padding, kernel, lambda, output_sigma_factor, interp_factor, ...
        cell_size, features, show_visualization);
